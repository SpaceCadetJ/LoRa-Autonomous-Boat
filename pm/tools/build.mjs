...
{id:'A1',title:'Footprints',status:'Reported complete',detail:'Project-local geometry reconstructed; 44 footprints.',source:'hardware/kicad/LoRa_Boat_Controller.pretty'},
...
{id:'A4',title:'Baseline documentation',status:'In progress',detail:'Copper evidence, report and final baseline handoff.',source:'AGENT_STATUS.md'},
{id:'B',title:'Review and requirements',status:'Next gate',detail:'Turn V1 defects, voice/RC needs and operating limits into acceptance tests.',source:'BLOCKERS.md'},
{id:'C',title:'Successor implementation',status:'Planned',detail:'Reviewed hardware, integrated firmware and measured application performance.',source:'reviews/codex/PLATFORM_CONCEPT.md'}
];
...
bom,datasheets,documents:documentData,images,reports,findings,phases,connectors:connectorData?.connectors||[],connector_meta:connectorData?{generated_at:connectorData.generated_at,sources:connectorData.sources}:null,software,independent,sources,
