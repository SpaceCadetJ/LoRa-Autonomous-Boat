...
if(exists('reviews/codex/imu_interface/v2_imu_candidate.svg'))images.push({path:'reviews/codex/imu_interface/v2_imu_candidate.svg',title:'IMU 1.8 V candidate - not integrated into PCB',type:'svg'});
if(exists('reviews/codex/imu_placement/v2_imu_placement.svg'))images.push({path:'reviews/codex/imu_placement/v2_imu_placement.svg',title:'IMU placement study - copper conflicts, not integrated',type:'svg'});
...
for(const p of ['reviews/codex/imu_placement/study/IMU_PLACEMENT_STUDY.kicad_pro','reviews/codex/imu_placement/study/IMU_PLACEMENT_STUDY.kicad_pcb'])if(exists(p))data.available_paths.push(p);
